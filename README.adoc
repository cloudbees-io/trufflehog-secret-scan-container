...
This Action integrates TruffleHog, an open-source secret scanning tool, into CI/CD pipelines to detect secrets and sensitive information in Docker images.
